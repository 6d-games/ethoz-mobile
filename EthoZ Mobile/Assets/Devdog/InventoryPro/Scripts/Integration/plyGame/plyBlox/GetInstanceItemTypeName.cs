...
namespace Devdog.InventoryPro.Integration.plyGame.plyBlox
{
    ...
    {
        [plyBlockField("Item", ShowName = true, ShowValue = true, DefaultObject = typeof(SystemObject_Value), EmptyValueName = "-error-", SubName = "InventorySystem item", Description = "The item we wish to get the type name of.")]
