...
public class EnviroSkyLiteEditor : Editor {
	...
	private string latestVersion = "2.1.1";
	// GUI Styles
    ...
    SerializedProperty renderClouds, particleClouds, dayNightSwitch, usePostEffectFog, useUnityFog;
    SerializedProperty springBaseTemperature, summerBaseTemperature, autumnBaseTemperature, winterBaseTemperature, temperatureChangingSpeed;
